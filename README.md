...
### Shared Tasks
- [Dialog State Tracking Challenge (DSTC)](http://workshop.colips.org/dstc5/)
...
### Shared Tasks
- [CLEF Question Answering Track](http://nlp.uned.es/clef-qa/)
- [NTCIR – QA Lab](http://research.nii.ac.jp/qalab/)
